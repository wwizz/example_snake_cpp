...
#include "support/network/sockets/bsd/SocketConst.h"
...
namespace support {
    ...
    void SocketUdp::Impl::thread_send_data(string data, support::SocketAddress address_remote, SocketCallback callback) {
