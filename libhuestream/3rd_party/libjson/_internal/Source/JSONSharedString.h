	...
	struct iterator;
	  struct const_iterator {
		const_iterator(const json_char * p, const json_shared_string * pa) : parent(pa), it(p){}
         ...
         inline const_iterator & operator =(const const_iterator & orig) json_nothrow{ it = orig.it; parent = orig.parent; return *this; }
...
#pragma GCC diagnostic pop
	  ...
	  struct iterator {
		iterator(const json_char * p, const json_shared_string * pa) : parent(pa), it(p){}
         ...
         inline iterator & operator =(const iterator & orig) json_nothrow{ it = orig.it; parent = orig.parent; return *this; }
