...
TEST_F(TestConnectionFlow_Manual, manual_bridge_has_ssl_enabled__small_config_has_old_api__ssl_still_enabled) {
    expect_message(FeedbackMessage::ID_USERPROCEDURE_STARTED, FeedbackMessage::FEEDBACK_TYPE_INFO);
    expect_storage_accessor_load_return_data();
...
TEST_P(TestConnectionFlow_Manual, manual_bridge_https__no_existing_bridges_ssl_disabled__small_config_has_new_api__ssl_enabled) {
...
TEST_P(TestConnectionFlow_Manual, manual_bridge_https__existing_bridge_ssl_disabled__small_config_has_new_api__ssl_enabled) {
    bool connect_by_ip = GetParam();
...
TEST_P(TestConnectionFlow_Manual, manual_bridge_https__existing_bridge_has_ssl_enabled__small_config_has_old_api__ssl_still_enabled) {
    bool connect_by_ip = GetParam();
...
TEST_P(TestConnectionFlow_Manual, manual_bridge_https__no_existing_bridges__old_model_id__small_config_has_new_api__ssl_still_disabled__bridge_search_starts) {
    bool connect_by_ip = GetParam();
