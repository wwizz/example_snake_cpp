...
mkdir $FAKE_GIT_DIR3
INCLUDE="."
EXCLUDE="cmake-build-debug|cmake|tools|libhuestream\\/test|examples\\/huestream_example_gui_win\\/resource.h|examples\\/huestream_example_gui_win\\/stdafx.h|wrappers"
