...
macro( CSHARP_ADD_PROJECT type name )
  ...
  foreach( it ${ARGN} )
    if( ${it} MATCHES "(.*)(dll)" )
      ...
      list( APPEND refs /reference:${nit} )
    else( )
      # Argument is a source file
      if( EXISTS ${it} )
        file(TO_NATIVE_PATH ${it} nit)
        list( APPEND sources ${nit} )
  ...
  set(CSHARP_OUTPUT_DIR ${CSHARP_BINARY_DIRECTORY})
...
if (WIN32)
  ...
  add_custom_command(
          ...
          OUTPUT ${CSHARP_OUTPUT_DIR}/${name}.${output}
  ...
  add_custom_target(
          ${name} ALL
          DEPENDS ${CSHARP_OUTPUT_DIR}/${name}.${output}
          SOURCES ${sources_dep}
  )
